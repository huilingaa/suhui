	...
	export default {
		props: {
			...
			line2Style: { //line2线条的样式
				type: String,
				default: 'height: 6rpx;border-radius: 4rpx;'
			},
			animationMode: { //动画类型
				type: String,
				default: 'line1'
			...
			activeStyle: { //line1模式选中项的样式
				type: String,
				default: 'bottom:0;left:50%;transform: translate(-50%,-100%);height: 6rpx;border-radius:0rpx;background: linear-gradient(270deg,#c4dbff, #6c68fc 4%, #6895fc 10%, #49bdff 27%, #1693db 57%, #1d7fd4 85%, #0c6cd5);'
			},
		...
		computed: {
			...
			getActiveStyle() {
				return `width:44rpx;background-color:${this.getActiveColor};${this.activeStyle};`;
			},
			getDefaultStyle() {
