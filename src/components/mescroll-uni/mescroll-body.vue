...
<script>
	...
	export default {
		...
		created() {
          ...
          textLoading: this.$t('loading' || '加载中...'),
          textInOffset: this.$t('downUpdate' || '下拉刷新'),
          textOutOffset: this.$t('releaseUpdate' || '释放更新'),
          textSuccess: this.$t('loadSuccess' || '加载成功'),
          textErr: this.$t('loadError' || '加载失败'),
				},
				// 上拉加载的配置
				up: {
					// 显示加载中的回调
