<template>
  <view class="home">
    ...
    <div class='content'>
      <li>
        <p>当前净值：<span>$12.23</span></p>
        <p>可用余额：<span>$12.23</span></p>
      </li>
      <li>
        <p>累计金额：<span>$12.23</span></p>
        <p>当年年化：<span>$12.23</span></p>
      </li>
      <li>
        <p>实现盈亏：<span>$12.23</span></p>
        <p>浮动盈亏：<span>$12.23</span></p>
      </li>
    ...
    <div class='list'>
      ...
      <div class='boxLi' v-for="(item,index) in [1,2]" :key='index'>
        <div class='li'>
          <div class='top'>
            <li>蜘蛛网格
              <p>已跟谁48小时</p>
